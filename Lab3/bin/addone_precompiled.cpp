...
int main(int argc, const char* argv[])
{
	...
	/* Skeleton instances */
	skepu::backend::Map<1, skepu_userfunction_skepu_skel_0addOneMap_addOneFunc, bool, CLWrapperClass_addone_precompiled_MapKernel_addOneFunc_arity_1> addOneMap(false);
